...
{
    std::vector<int> numberOfTasks = { 40, 45 };
...
void testSchedulabilityRatioVsUtilizations()
{
    ...
    std::vector<int> numberOfChains = { 3 };
    std::vector<std::vector<double>> utilizationsForCores = { {0.7, 0.7}, { 0.9, 0.9 } };
    int numberOfCommunicatingPairs = 16;
...
void testIndustrialTestCase()
{
    ...
    createAndSolveModel(taskSets, taskChains, numberOfSolutions, status, maximumInterCoreDelay, true);
